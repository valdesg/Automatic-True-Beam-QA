function update_couch_position_geometry_calibration(file_name, couch_vector_KV_CBCT_file) 
...
% different images appear on the XML document. 
...
xmlwrite(['KV flexmap isocenter positioning updated' '.xml'],xDoc);
